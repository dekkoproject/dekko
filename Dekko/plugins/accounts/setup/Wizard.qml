...
Flickable {
    id: wizard
    // online accounts expects a flickable as the root component so lets settle that
    // but make it non flickable and leave it up to the sub pages pushed onto the stack.
    anchors.fill: parent
    interactive: false

    property bool isPreset: false
    property string accountType: "imap"
